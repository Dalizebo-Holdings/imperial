      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        ...
        <div className="nav-links">
          {navigation.map((item) => {
            ...
            const isPending = ["/phase9", "/realtime"].includes(item.href);
          ...
          <div className="grid">
            ...
            <div className="card">
              ...
              <ul style={{ fontSize: "14px", lineHeight: 1.8, color: "var(--color-text-secondary)" }}>
                <li><strong>local:</strong> Development with seeded demo data</li>
                <li><strong>staging:</strong> Pre-production validation (deferred)</li>
                <li><strong>beta:</strong> Limited external access (deferred)</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="section">
          ...
          <div className="grid">
            <div className="card">
              ...
              <p style={{ color: "var(--color-text-secondary)", fontSize: "14px" }}>
                Demo tenant: <code>demo-org</code> / <code>demo-workspace</code> / <code>demo-project</code> / <code>development</code>
              </p>
            </div>
            <div className="card">
              <h3 className="card-title">Tenant Scoping</h3>
              <p style={{ color: "var(--color-text-secondary)", fontSize: "14px" }}>
                All data operations are scoped to the current tenant. Cross-tenant access is blocked at the Kernel and BaaS layers.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section">
          ...
          <div className="grid">
            <div className="card">
              ...
              <p style={{ color: "var(--color-text-secondary)", fontSize: "14px" }}>
                Running in sandbox mode. No real charges. Production billing adapters are feature-flagged.
              </p>
            </div>
            <div className="card">
        ...
        <section className="section">
          ...
          <div className="card">
            <p style={{ color: "var(--color-text-secondary)", fontSize: "14px", marginBottom: "16px" }}>
              Seeded demo data is clearly separated from evidence data. Evidence ingestion uses the private inbox workflow; demo fixtures are excluded from Phase 7 validation.
            </p>
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
              <span className="status-badge complete">Demo Data: SEEDED</span>
              <span className="status-badge complete">Evidence: ISOLATED</span>
              <span className="status-badge pending">Production: BLOCKED</span>
            </div>
          </div>
        </section>
      </main>
