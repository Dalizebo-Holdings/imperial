...
FILE = (
    ROOT
    / "constitution/reconciliation/review/pillar-review.csv"
)
...
if len(cluster) != 65:
    raise SystemExit(
        f"ERROR: Expected 65 Cluster B Pillars, found {len(cluster)}."
    )
...
print("OK: Cluster B 041–105 constitutionally reconciled.")
